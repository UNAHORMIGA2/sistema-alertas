    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.card}>
        <View style={styles.avatarWrap}>
          <Ionicons name="shield-outline" color="#FFFFFF" size={28} />
        </View>
        <Text style={styles.name}>{nombre || "Unidad de Policia"}</Text>
        ...
        <View style={styles.infoBox}>
          <Text style={styles.infoText}>Ubicacion habilitada para recibir y atender alertas.</Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  termsButtonText: { color: "#1D4ED8", fontWeight: "700", fontSize: 14 },
});
