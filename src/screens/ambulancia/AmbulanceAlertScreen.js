...
export default function AmbulanceAlertScreen({ navigation, route }) {
  ...
  const goToReport = async () => {
    if (alertId) {
      try { await api.patch(`/mobile/asignaciones/${alertId}/estado`, { estado: "atendiendo" }); } catch {}
    }
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.line}>Unidad asignada: {alert?.unidadAsignada || "Ambulancia"}</Text>
